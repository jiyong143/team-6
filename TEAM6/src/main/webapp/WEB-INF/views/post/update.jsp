			...
			<div class="board-postList">
				<table>
					...
					<h2>게시글 수정</h2>
						...
						<input type="text" id="title" name="title" class="title" value="${post.po_title}">
					</div>
					<div class="post-insert">
						<label for="writer">아이디</label> 
						<input type="text" id="writer" name="writer" class="title" value="${user.me_id}" readonly>
					</div>
					<div class="post-insert">
						<label for="name">작성자</label> 
						<input type="text" id="name" name="name" class="title" value="${user.me_name}" readonly>
					</div>
					<div class="post-insert">
