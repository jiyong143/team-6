...
<head>
<meta charset="UTF-8">
<title>What do you want to ask? - 카테고리 등록</title>
<style>
a {
	color: #333;
...
.post-insert input[type="text"] {
	width: 100%;
	padding: 10px;
	font-size: 16px;
	border: 1px solid #ccc;
	border-radius: 5px;
	box-sizing: border-box; /* 내용 영역 크기를 보더와 패딩을 포함하여 계산 */
}
/* 버튼 스타일 */
button[type="submit"] {
	margin-top:10px;
			...
			<div class="board-postList">
				<table>
					...
					<div class="post-insert">
						<label for="ca_title">카테고리 명:</label> <input type="text"
							id="ca_title" placeholder="카테고리명을 입력하세요. . ." name="ca_title">
