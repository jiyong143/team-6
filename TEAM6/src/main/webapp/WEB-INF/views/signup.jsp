...
<body>
	...
	<div class="signup-group">
		...
		<form name="join_form" id="join_form" method="post"
			...
			<div class="signup">
				<label for="pw2">비밀번호</label> <input type="password" id="pw2"
					name="pw2" placeholder="비밀번호 확인">
			</div>
			<div class="signup">
				<label for="birth">생년월일(주민등록 앞 6자리):</label> <input type="text"
					id="birth" placeholder="생년월일을 입력하세요" name="birth">
			</div>
			<div class="signup">
				<label for="phone">핸드폰 번호</label> <input type="number" id="phone"
			...
			<div class="signup">
				<label for="address">주소(양식 : OO시 OO구 OO동)</label> <input type="text"
